import { Logo, pantalla1, pantalla2 } from "../const.ts";
...
export const Landing = () => {
    ...
    return (<Pantalla>
      ...
      <Contenidodos>
        <div>
          <figure data-aos="fade-right">
            <img className="animate__animated animate__fadeInUp" src={pantalla1} alt=""/>
          </figure>
      ...
      <Contenidotres id="hacer">
        <div>
          <figure data-aos="fade-right">
            <img className="animate__animated animate__fadeInUp" src="https://i.postimg.cc/HntT2xgP/map.png" alt=""/>
          </figure>
          <div data-aos="fade-up">
        ...
        <div>
          ...
          <figure data-aos="fade-right">
            <a href="https://github.com/josephRodriri/" target="_blank">
              <img className="animate__animated animate__fadeInUp" src="https://res.cloudinary.com/dehpi4905/image/upload/v1728453062/J-C/nju9cb6obzg6wujva5o0.png" alt=""/>
            </a>
        ...
        <div>
          ...
          <figure data-aos="fade-right">
            <a href="https://portafolio-v2-three.vercel.app/" target="_blank">
              {" "}
              <img className="animate__animated animate__fadeInUp" src="https://avatars.githubusercontent.com/u/106413561?s=400&u=a6b3cbd811ee9c6e211750fc25395125086b44af&v=4" alt=""/>
            </a>
            <h3>Camilo Sol</h3>
            <p>Desarrollador web</p>
          </figure>
